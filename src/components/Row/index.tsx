...
const Row:FC<Props> = ({row, rowIndex, columnIndex}) => {
    ...
    const handleCanDrop = (dragItem: RowDragItem, dropZone: RowDropZone): boolean => !(dragItem?.columnIndex === dropZone?.columnIndex && dragItem?.rowIndex === dropZone?.rowIndex);
    ...
    return (
        <div
            ...
            draggable
        >
            <DropZone accept='row' dropZoneData={{...row, rowIndex, columnIndex}} onDrop={handleDrop} handleCanDrop={handleCanDrop}>
                {row?.title && (
